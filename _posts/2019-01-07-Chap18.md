...
<div>
<img class="aside" src="18.1.1.svg" alt="A quadrilateral" />
边：$AB,BC,CD,DA$
<br />
...
<ly-b>
<img class="aside" src="18.1.3.svg" alt="A trapezium" />
$$
四边形(平行)\begin{cases}
...
<ly-b>
<img class="aside" src="18.1.4.svg" alt="A parallelogram" />
$$
\because 四边形ABCD是平行四边形\\
...
<ly-b>
<img class="aside" src="18.1.5.svg" alt="A parallelogram with two diagonals" />
$$
\because 四边形ABCD是平行四边形\\
...
## 六、易错
<div>
<img class="aside" src="18.1.6.svg" alt="A parallelogram" />
&#9312;“上、下”是$AD$和$BC$
<br />
$\angle3$和$\angle4$
<br />
...
## 七、距离（最短路程）
&#9312;两点间的距离是线段长.
<img class="main" src="18.1.7.svg" alt="Comparing curved line and straight line" />
<ly-q date="20190226">清楚和模糊，决定你以后人生是好运还是稀里糊涂</ly-q>
<ly-q date="20190226">好人占一半，坏人占一半。我们平时当好人，考试的时候当坏人</ly-q>
&#9313;点在直线外，点到直线的距离.
<img class="main" src="18.1.8.svg" alt="Comparing the lenth of the perpendicular line and not perpendicular ones" />
&#9314;<ly-old>两条线的距离.</ly-old><ly-rep>两条平行线间的距离处处相等.</ly-rep>
<img class="main" src="18.1.9.svg" alt="Showing the distance between two parallel lines stays the same" />
...
## 一、平行四边形的判定
<div>
<img class="aside" src="18.1.10.svg" alt="A parallelogram" />
...
<ly-e>
<img class="aside" src="18.1.11.svg" alt="A parallelogram with four angle bisectors" />
...
<ly-b>
<img class="aside" src="18.1.12.svg" alt="A triangle with a median" />
$$
\because 点D是AB中点，点E是AC中点\\
\therefore DE是\triangle ABC的中位线
$$
</ly-b>
<ly-q date="20190305">手机一开始天线在外面<img class="inline" src="18.1.13.svg" alt="A phone with an antenna" />，但是后来发现不方便装，所以现在天线就在里面了。这就需要新的知识。</ly-q>
## 二、性质
...
求证：四边形$EGHF$是平行四边形.
<img class="aside" src="18.1.14.svg" alt="Two triangles with a common side, two medians" />
$$
证明：
...
<img class="aside" src="18.1.15.svg" alt="A quadrilateral with four midpoints connected" />
$$
解：判断：四边形EFGH是平行四边形.\\
理由如下：\\
连接AC\\
...
<ly-b>
<img class="aside" src="18.2.1.svg" alt="A rectangle" />
$$
\because 四边形ABCD是矩形\\
...
<ly-b>
<img class="aside" src="18.2.2.svg" alt="A rectangle with two digonals" />
$$
\because 四边形ABCD是矩形\\
...
<ly-b>
<img class="aside" src="18.2.3.svg" alt="A right triangle with the midline on the hypotenuse" />
$$
...
求证：$OC=OD$
<img class="aside" src="18.2.4.svg" alt="Two right triangles with a common hypotenuse" />
$$
...
<ly-b>
<img class="aside" src="18.2.5.svg" alt="A rectangle" />
$$
\because 四边形ABCD是平行四边形\\
...
<ly-b>
<img class="aside" src="18.2.6.svg" alt="A rhombus" />
$$
\because 四边形ABCD是菱形\\
\therefore AB//DC,AD//BC
$$
...
$$
\begin{aligned}
&#9312;\Huge{S}_{\small{菱形}}&=底 \times 高\\
&=4 \times S_{小直角三角形}\\
&=4 \times \frac{1}{2}(OA\times OD)\\
&=\frac{1}{2} (2OA \times 2OD)\\
&#9313;S_{菱形}&=\frac{1}{2}AC \cdot BD
\end{aligned}
$$
</ly-old>
<ly-rep>
...
<ly-b>
<img class="aside" src="18.2.7.svg" alt="A square" />
$$
\because 四边形ABCD是正方形
$$
<ly-r>
...
<ly-b>
<img class="aside" src="18.2.8.svg" alt="A square with two diagonals" />
$$
\because 四边形ABCD是正方形\\
...
<img class="aside" src="18.2.9.svg" alt="Graph for example 4" />
...
求证：四边形$CEDF$是正方形.
<img class="aside" src="18.2.10.svg" alt="Graph for example 3" />
$$
证明：\\
...
求证：四边形$ABCD$是正方形.
<img class="aside" src="18.2.11.svg" alt="Graph for example 4" />
$$
证明：\\
...
求证：四边形$EFGH$是平行四边形
<img class="aside" src="18.3.1.svg" alt="quadrilateral with connected midpoints" />
$$
证明：连接AC\\
\because 点E是AB中点,点F是BC中点\\
...
<ly-b>
<img class="aside" src="18.3.2.svg" alt="quadrilateral with equal diagonals with connected midpoints" />
$$
...
<img class="main" src="18.3.3.svg" alt="kite with connected midpoints" />
<ly-q date="20190321" towhom="张炜昊">你在家，口渴了，你就叫一天‘口渴了’‘口渴了’，渴死你</ly-q>
# 专题二
1.连接平行四边形各边中点，围成小<u>平行四边形</u>
<img class="main" src="18.4.1.svg" alt="parallelogram with connected midpoints" />

2.连接矩形各边中点，围成小<u>菱形</u>
<img class="main" src="18.4.2.svg" alt="rectangle with connected midpoints" />
...
<img class="main" src="18.4.3.svg" alt="rhombus with connected midpoints" />
